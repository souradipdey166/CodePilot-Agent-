from agent.nodes import error_analysis, repository_exploration, code_inspection, root_cause_hypothesis, patch_generation
...
print("\nPATCH_OLD:")
print(repr(state["patch_old"]))
print("\nPATCH_NEW:")
print(repr(state["patch_new"]))