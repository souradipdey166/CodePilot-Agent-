...
state: DebugState = {
    ...
    "bug_report": "The bitcount function should count the number of 1-bits in a number's binary representation. For example, bitcount(127) should return 7, and bitcount(128) should return 1. It's returning incorrect counts for some inputs.",
